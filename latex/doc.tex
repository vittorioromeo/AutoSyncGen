...
\def \cppStart {\begin{minted}[mathescape, linenos, numbersep=5pt, gobble=2, frame=lines, framesep=2mm]{cpp}}
    ...
    \newpage
        ...
        \chapter{Conclusion}
            ...
            \section{Learning experience}
                ...
                Creating \emph{AutoSyncGen} was a very useful exercise in \emph{C++ modern metaprogramming techniques} and \emph{computer networking}.
